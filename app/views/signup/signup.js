  ...
  template:
    `<div class="register__modal content">
      <div class="register__modal__header">
        ...
        <p translate="SIGNUP" class="sectionHeader"> </p>
      </div>
      <div class="register__modal__form">
          <label translate="NAME" for="reg_name"></label>
          <input class="reg__input" id="reg_name" name="name" ng-model="$ctrl.name" ng-blur="$ctrl.onChange({user: $ctrl.userObj()})">
          <label translate="SURNAME" for="reg_surname"></label>
          <input class="reg__input" id="reg_surname" name="surname" ng-model="$ctrl.surname" ng-blur="$ctrl.onChange({user: $ctrl.userObj()})">
          ...
          <input class="reg__input" id="reg_password" translate translate-attr-placeholder="PASSWORD_TEXT" type="password" name="password" ng-model="$ctrl.password" ng-blur="$ctrl.onChange({user: $ctrl.userObj()})">
          <input class="reg__input" id="reg_password_copy" translate translate-attr-placeholder="PASSWORD_TEXT_COPY" type="password" name="password" ng-model="$ctrl.passwordCopy" ng-blur="$ctrl.onChange({user: $ctrl.userObj()})">
        <div class="reg__btns" >
